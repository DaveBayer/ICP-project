...
#include "src/transportvehicle.h"
...
QT_MOC_LITERAL(1, 17, 17), // "getConnectionInfo"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 17), // "TransportVehicle*"
QT_MOC_LITERAL(4, 54, 8) // "finished"

    },
    "TransportVehicle\0getConnectionInfo\0\0"
    "TransportVehicle*\0finished"
};
...
void TransportVehicle::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        TransportVehicle *_t = static_cast<TransportVehicle *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->getConnectionInfo((*reinterpret_cast< TransportVehicle*(*)>(_a[1]))); break;
        ...
        {
            typedef void (TransportVehicle::*_t)(TransportVehicle * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&TransportVehicle::getConnectionInfo)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject TransportVehicle::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TransportVehicle.data,
      qt_meta_data_TransportVehicle,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void TransportVehicle::getConnectionInfo(TransportVehicle * _t1)
{
